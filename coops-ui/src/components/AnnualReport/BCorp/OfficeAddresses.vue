<template>
  <section>
    <header>
      <h2 class="AR-step-header">2. Office Addresses
        <span class="ar-date">( as of {{ this.toReadableDate(this.nextARDate) }} )</span>
      </h2>
      <p>Verify or change your Registered and Record Office Addresses.</p>
    </header>
    <v-card flat>
...
export default class OfficeAddresses extends DateMixin {
  /**
  ...
  private resetAddress (): void {
    this.inheritDeliveryAddress = true
