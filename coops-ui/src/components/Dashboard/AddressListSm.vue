            ...
            <v-list-item-content>
              ...
              <v-list-item-subtitle>
                <ul class="address-info">
                  ...
                  <li>{{ registeredAddress.deliveryAddress.addressCountry }}</li>
                </ul>
              </v-list-item-subtitle>
            </v-list-item-content>
          </v-list-item>
            ...
            <v-list-item-content>
              ...
              <v-list-item-subtitle>
                ...
                <ul class="address-info" v-else>
                  ...
                  <li>{{ registeredAddress.mailingAddress.addressCountry }}</li>
                </ul>
              </v-list-item-subtitle>
            </v-list-item-content>
          </v-list-item>
            ...
            <v-list-item-content>
              ...
              <v-list-item-subtitle>
                <ul class="address-info">
                  ...
                  <li>{{ recordsAddress.deliveryAddress.addressCountry }}</li>
                </ul>
              </v-list-item-subtitle>
            </v-list-item-content>
          </v-list-item>
            ...
            <v-list-item-content>
              ...
              <v-list-item-subtitle>
                ...
                <ul class="address-info" v-else>
                  ...
                  <li>{{ recordsAddress.mailingAddress.addressCountry }}</li>
                </ul>
              </v-list-item-subtitle>
            </v-list-item-content>
          </v-list-item>
